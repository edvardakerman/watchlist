    ...
    return (
        <footer className='bg-transparent text-white p-5 lg:px-8'>
            ...
            <div>
                ...
                <span className="block text-xs sm:text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link href="/" className="hover:underline">MyAwesomeMovies.com</Link>. All Rights Reserved.</span>
            </div>
        </footer>
    );
}
