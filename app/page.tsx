  ...
  return (
    <div className="flex flex-col sm:items-center sm:justify-center">
      <div className="sm:my-10 text-center space-y-2 sm:space-y-5">
        <h1 className="text-4xl font-bold text-off_white">Welcome to My Awesome Movies</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 mt-8 sm:mb-14 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-text_color">
        <div className="flex flex-col items-center justify-center text-center p-5 sm:p-10">
